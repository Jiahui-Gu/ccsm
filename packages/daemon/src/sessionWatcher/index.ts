...
import { FileSource, type FileTick } from './fileSource.js';
...
import { PendingRenameFlusherSink, type PendingFlusher } from './pendingRenameFlusher.js';
import type { WatcherState } from './inference.js';

export type { WatcherState } from './inference.js';
export type { TitleFetcher } from './titleEmitter.js';
export type { PendingFlusher } from './pendingRenameFlusher.js';

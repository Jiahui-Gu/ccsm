...
describe('ccsmCore preload bridge', () => {
  ...
  it('exposes a stable top-level key set under "ccsm"', () => {
    ...
    expect(Object.keys(api).sort()).toEqual(
      [
        ...
        'i18n',
        'loadState',
        'mobileRemoteAuthState',
        'mobileRemoteLogin',
        'mobileRemoteLogout',
        'onMobileRemoteAuthState',
        'onUpdateDownloaded',
        'onUpdateStatus',
        'openExternal',
        'pathsExist',
  ...
  // (Former `featureFlags` test removed — the CCSM_WARM_XTERM /
  // CCSM_WARM_XTERM_CAP surface was deleted alongside the env-flag-gated
  // warm-xterm path. The warm registry is now the only terminal path
  // with no env-flag plumbing.)

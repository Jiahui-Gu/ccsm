              ...
              {group.commands.map((cmd) => {
                ...
                return (
                  ...
                  >
                    ...
                    {(() => {
                      // Generic right-aligned trailing slot. Built-in
                      // `/think` previously rendered a Switch facsimile
                      // here; that command was removed in favour of the
                      // StatusBar Thinking chip. The slot stays available
                      // for any future built-in that wants a small live
                      // indicator next to its name.
                      const trailing = cmd.trailingComponent ?? null;
                      return trailing ? (
                        <span
                          className={cn(

              ...
              {group.commands.map((cmd) => {
                ...
                return (
                  ...
                  >
                    ...
                    {(() => {
                      // Trailing slot: dynamic commands with a custom slot
                      // can render here. Built-ins no longer use this path
                      // (the `/think` Switch was removed when the 6-tier
                      // effort+thinking chip moved into the StatusBar).

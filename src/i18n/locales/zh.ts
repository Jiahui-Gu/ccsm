...
const zh: EnCatalog = {
  ...
  settings: {
    ...
    mobileRemote: {
      title: '配对手机',
      intro: '将手机安全地连接到这台 CCSM 桌面端。无需配置中继服务。',
      relay: '中继状态',
      desktop: '桌面端',
      phone: '手机',
      ready: '就绪',
      connecting: '连接中',
      paused: '已暂停',
      relayUnavailable: '中继不可用',
      secureStorageUnavailable: '安全存储不可用',
      connectionError: '连接错误',
      updateRequired: '需要更新',
      pairingError: '配对错误',
      desktopConnected: '桌面端已连接',
      desktopConnecting: '桌面端正在连接中继…',
      desktopPaused: '桌面端遥控已暂停',
      desktopUnavailable: '桌面端遥控不可用',
      desktopError: '桌面端中继连接失败',
      phoneConnected: '手机已连接',
      phoneWaiting: '等待手机连接',
      phonePaused: '手机连接已暂停',
      phoneUnavailable: '手机连接不可用',
      pairTitle: '扫码配对',
      pairHint: '打开手机相机，扫描此私密配对码。',
      qrAria: '手机配对二维码',
      refreshQr: '刷新二维码',
      pause: '暂停手机遥控',
      resume: '恢复手机遥控',
      rotateTitle: '替换配对？',
      rotateDescription: '当前二维码和已配对的手机将立即失效。',
      rotateConfirm: '替换',
      rotateCancel: '取消',
      relayUnavailableDetail:
        '此版本未配置手机中继。请安装最新版 CCSM；开发环境可设置 CCSM_MOBILE_REMOTE_RELAY_URL。',
      secureStorageDetail: '此设备无法安全保护配对凭据。请启用操作系统凭据存储后重启 CCSM。',
      connectionErrorDetail: 'CCSM 无法连接手机中继。请检查网络后重试。',
      updateRequiredDetail: '请更新 CCSM 以使用当前的手机中继协议。',
      pairingErrorDetail: '配对认证失败。请刷新二维码并重新配对。'
    }
  },
  notifications: {

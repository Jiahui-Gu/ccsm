...
const en = {
  ...
  settings: {
    ...
    fontSizeAppliesHint: 'Applies to the whole app. Explicit small labels (meta, kbd) keep their intrinsic size.',
    ...
    notifications: {
      intro: 'OS-level toasts when a session needs your attention. Suppressed when the window is focused on that same session, and debounced per session per event type so a chatty agent cannot spam you.',
      enable: 'Enable notifications',
      permissionPrompts: 'Permission prompts',
      permissionPromptsHint: 'When a tool call is waiting on your approval.',
      questions: 'Questions',
      questionsHint: 'When the agent uses AskUserQuestion to ask you something.',
      turnDone: 'Turn done',
      turnDoneHint: 'Only fires for long (>15s), errored, or unfocused turns - routine fast turns are skipped.',
      sound: 'Sound',
    ...
    updates: {
      ...
      automaticChecksHint: 'When on, Agentory checks GitHub for updates on launch and every 4 hours.',
    ...
    endpoints: {
      intro: 'Agentory talks to any server that speaks the Anthropic REST API: anthropic.com, a self-hosted gateway, or a LiteLLM / Kimi / DeepSeek shim. Add one here and Agentory will discover its models via',
      addBtn: 'Add Endpoint',
      loading: 'Loading Endpoints…',
      empty: 'No Endpoints yet. Click "Add Endpoint" to point Agentory at Anthropic or your own gateway.',
      removeConfirm: 'Remove Endpoint "{{name}}"?',
      defaultBadge: 'default',
      statusConnected: 'connected',
      statusError: 'error',
      statusUnchecked: 'unchecked',
      kindLabelTooltip: 'Detected Endpoint kind: {{label}}',
      kindUnknown: 'Unknown',
      modelCount: '{{count}} Model',
      modelCount_other: '{{count}} Models',
      sourceListed: '{{count}} listed',
      sourceCliPicker: '{{count}} CLI picker',
      sourceEnvOverride: '{{count}} env override',
      sourceFallback: '{{count}} fallback',
      sourceManual: '{{count}} manual',
      sourceNoData: 'no discovery data yet',
      refreshed: 'refreshed {{when}}',
      cachedSuffix: ' (cached)',
      authFailed: 'Auth failed — check your API key for this Endpoint.',
      noModelsFound: 'Could not auto-discover any Models. Edit this Endpoint and add manual Model IDs below.',
      ...
      editorAddTitle: 'Add Endpoint',
      editorEditTitle: 'Edit Endpoint',
      fieldName: 'Name',
      fieldNamePlaceholder: 'e.g. Anthropic, My LiteLLM',
      fieldProtocol: 'Protocol',
      fieldProtocolValue: 'Anthropic-compatible (REST)',
      fieldBaseUrl: 'Base URL',
      fieldBaseUrlHint: 'Paste the API root, e.g. https://api.anthropic.com — Agentory uses it as-is for /v1/messages and probes /v1/models for discovery.',
      fieldBaseUrlPlaceholder: 'https://api.anthropic.com',
      fieldApiKey: 'API key (optional)',
      fieldApiKeyHintExisting: 'Leave blank to keep the existing key.',
      fieldApiKeyHintNew: 'Optional — leave blank if your Endpoint does not require authentication.',
      fieldApiKeyPlaceholderUnchanged: '••••••• (unchanged)',
      revealKey: 'Reveal key',
      hideKey: 'Hide key',
      showBtn: 'Show',
      hideBtn: 'Hide',
      fieldDefault: 'Default Endpoint',
      fieldDefaultHint: 'Used for new Sessions that don\u2019t pick one.',
      fieldDefaultMake: 'Make default',
      fieldManualIds: 'Manual Model IDs',
      fieldManualIdsHint: 'Optional. One ID per line (or comma-separated). Used as additional Model picks alongside whatever claude.exe reports — IDs that aren\u2019t in claude\u2019s catalogue are still kept in the picker, marked unverified.',
      testing: 'Testing…',
      testOk: 'Connected.',
      saving: 'Saving…',
      save: 'Save',
  ...
  toasts: {
    persistErrorTitle: 'Failed to save state',
    persistErrorBody: 'Your recent changes may not survive restart. Check disk space.',
    backgroundWaitingTitle: '{{name}} needs your input',
    updateDownloadedTitle: 'Update downloaded — restart to apply',
    updateDownloadedBody: 'Version {{version}} is ready.',
    restart: 'Restart'
  }
} as const;

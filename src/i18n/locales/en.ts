...
const en = {
  ...
  settings: {
    ...
    mobileRemote: {
      ...
      intro: 'Use your phone as a secure remote for this CCSM desktop. No relay settings are required.',
      relay: 'Relay status',
      desktop: 'Desktop',
      phone: 'Phone',
      ready: 'Ready',
      ...
      desktopConnecting: 'Desktop is connecting to the relay…',
      desktopPaused: 'Desktop remote is paused',
      desktopUnavailable: 'Desktop remote is unavailable',
      desktopError: 'Desktop relay connection failed',
      phoneConnected: 'Phone connected',
      phoneWaiting: 'Waiting for phone',
      phonePaused: 'Phone connection paused',
      phoneUnavailable: 'Phone connection unavailable',
      pairTitle: 'Scan to pair',
      pairHint: 'Open your phone camera and scan this private pairing code.',
      qrAria: 'Phone pairing QR code',
      refreshQr: 'Refresh QR code',
      pause: 'Pause mobile remote',
      resume: 'Resume mobile remote',
      rotateTitle: 'Replace pairing?',
      rotateDescription: 'The current QR code and any paired phone will stop working.',
      rotateConfirm: 'Replace',
      rotateCancel: 'Cancel',
      ...
      connectionErrorDetail: 'CCSM cannot reach the mobile relay. Check your network and try again.',
      updateRequiredDetail: 'Update CCSM to use the current mobile relay protocol.',
      pairingErrorDetail: 'Pairing authentication failed. Refresh the QR code and pair again.'
    }
  },
  notifications: {
